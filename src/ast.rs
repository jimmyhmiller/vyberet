...
impl Expr {
    ...
    pub fn get_loc(&self) -> &Loc {
        match self {
            ...
            Expr::SPrimApp { l, .. } => l,
            Expr::SPrimVal { l, .. } => l,
            Expr::SInstantiate { l, .. } => l,
            Expr::SBlock { l, .. } => l,
            Expr::SUserBlock { l, .. } => l,
            Expr::STable { l, .. } => l,
            Expr::SLoadTable { l, .. } => l,
            Expr::STableSelect { l, .. } => l,
            Expr::STableFilter { l, .. } => l,
            Expr::STableOrder { l, .. } => l,
            Expr::STableExtract { l, .. } => l,
            Expr::STableUpdate { l, .. } => l,
            Expr::STableExtend { l, .. } => l,
            Expr::SFor { l, .. } => l,
            Expr::SCheck { l, .. } => l,
            Expr::SCheckTest { l, .. } => l,
            Expr::SCheckExpr { l, .. } => l,
